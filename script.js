...
let hourlyBody, hourlyBodyF, dailyBody, dailyBodyF, result;
...
async function weatherSearch (query="addis ababa") {
	try {
		const response = await fetch(`https://api.weatherapi.com/v1/forecast.json?key=63c24c6f33f742c3880114012232208&q=${query}&days=3`, {mode: 'cors'});
		result = await response.json();
	
		// console.log(result);
		
		hourlyBody = `<div class="bottom-element">
					<h4>6 am</h4>
				...
				`;
		hourlyBodyF = `<div class="bottom-element">
				<h4>6 am</h4>
		...
		dailyBody = `<div class="bottom-element">
					<h4>${getDayName(result.forecast.forecastday[0].date)}</h4>
					<h3>${result.forecast.forecastday[0].day.maxtemp_c + " °C"}</h3>
					<p>${result.forecast.forecastday[0].day.mintemp_c + " °C"}</p>
					<img src="${result.forecast.forecastday[0].day.condition.icon}" id="img1" alt="" width="40px" height="40px">
				</div>
				<div class="bottom-element">
					...
					<img src="${result.forecast.forecastday[1].day.condition.icon}" id="img2" alt="" width="40px" height="40px">
				</div>
				<div class="bottom-element">
					...
					<img src="${result.forecast.forecastday[2].day.condition.icon}" id="img3" alt="" width="40px" height="40px">
				</div>
			`;

		dailyBodyF = `<div class="bottom-element">
				<h4>${getDayName(result.forecast.forecastday[0].date)}</h4>
				<h3>${result.forecast.forecastday[0].day.maxtemp_f + " °F"}</h3>
				<p>${result.forecast.forecastday[0].day.mintemp_f + " °F"}</p>
				<img src="${result.forecast.forecastday[0].day.condition.icon}" id="img1" alt="" width="40px" height="40px">
			</div>
			<div class="bottom-element">
				<h4>${getDayName(result.forecast.forecastday[1].date)}</h4>
